...
void SceneManager::LoadSceneTextures()
{
	...
	bReturn = CreateGLTexture(
		...
		"mic");
	bReturn = CreateGLTexture(
		"../../Utilities/textures/allblack.png",
		"black");
	bReturn = CreateGLTexture(
		"../../Utilities/textures/basalt.jpg",
		"basalt");
	bReturn = CreateGLTexture(
		"../../Utilities/textures/render.jpg",
		"render");
	bReturn = CreateGLTexture(
...
void SceneManager::SetupSceneLights()
{
	...
	m_pShaderManager->setVec3Value("lightSources[0].position", 0.0f, 5.0f, 2.0f);
	...
	m_pShaderManager->setVec3Value("lightSources[1].position", 0.0f, 1.0f, 0.0f);
	m_pShaderManager->setVec3Value("lightSources[1].ambientColor", 0.4f, 0.4f, 0.4f);
...
void SceneManager::RenderScene()
{
	...
	//SetShaderColor(0.6f, 0.3f, 0.1f, 1.0f);//Brown
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-5.0f, 2.0f, 5.0f);
	...
	//SetShaderColor(0.2, 0.2, 0.2, 1);//Light Gray
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-5.0f, 2.5f, 5.33f);
	...
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(2.5f, 2.3f, 1.0f);
	...
	// draw the mesh with transformation values
	m_basicMeshes->DrawPlaneMesh(); //Computer Screen
	/****************************************************************/
	...
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(5.2f, 2.5f, 0.1f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(0.0f, 3.0f, -0.05f);
	...
	SetShaderColor(0.2, 0.2, 0.2, 1.0); //Gray Computer Monitor


	// draw the mesh with transformation values
	m_basicMeshes->DrawBoxMesh(); //Monitor Box
	/****************************************************************/
	...
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(0.25f, 0.25f, 0.35f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(2.5f, 0.0f, 2.05f);
	...
	//SetShaderColor(0.1, 0.1, 0.1, 1.0);  //Black
	SetShaderTexture("black");

	// draw the mesh with transformation values
	m_basicMeshes->DrawSphereMesh(); //Mouse1
	/****************************************************************/
	...
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(4.0f, 0.5f, 1.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-0.5f, 0.0f, 2.0f);
	...
	// draw the mesh with transformation values
	m_basicMeshes->DrawBoxMesh(); //keyboard
	/****************************************************************/
	...
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(0.25f, 0.15f, 0.45f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(2.5f, 0.0f, 2.0f);
	...
	// draw the mesh with transformation values
	m_basicMeshes->DrawTaperedCylinderMesh(); //Mouse2
	/****************************************************************/
	...
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(0.3f, 0.3f, 2.5f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-5.2f, 2.5f, 3.6f);
	...
	SetShaderTexture("black");
	// draw the mesh with transformation values
	m_basicMeshes->DrawBoxMesh(); //Mic Arm 1
	/****************************************************************/
	...
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(0.3f, 0.3f, 2.6f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-5.2f, 2.25f, 1.35f);
	...
	SetShaderTexture("black");
	// draw the mesh with transformation values
	m_basicMeshes->DrawBoxMesh(); //Mic Arm 2
	/****************************************************************/
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-4.9f, 1.3f, -0.7f);
	...
	SetShaderTexture("black");
	// draw the mesh with transformation values
	m_basicMeshes->DrawBoxMesh(); //Mic Arm 3
	/****************************************************************/



	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(0.10f, 0.6f, 0.1f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-5.5f, 2.1f, 2.5f);
	...
	SetShaderTexture("mictwo");
	// draw the mesh with transformation values
	m_basicMeshes->DrawCylinderMesh(); //Mic Arm Connector



	/******************************************************************/
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(30.0f, 0.5f, 5.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(0.0f, -0.25f, 2.75f);
	...
	SetShaderMaterial("wood");
	// draw the mesh with transformation values
	m_basicMeshes->DrawBoxMesh();  //Thick part of table under the plane
	/****************************************************************/



	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(2.5f, 4.5f, 2.5f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(0.0f, 0.0f, -0.15f);
	...
	SetShaderTexture("mictwo");
	// draw the mesh with transformation values
	m_basicMeshes->DrawPyramid4Mesh();  //Under monitor base
